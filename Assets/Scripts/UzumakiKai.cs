...
public class UzumakiKai : Uzumaki
{
    private protected int count;

    public UzumakiKai(float degInterval = 10f, float radius = 100f, float makeInterval = 0.1f, float speed = 5f, int count = 5)
    {
    ...
    public IEnumerator MakeUzumakiKai(RectTransform center, BulletCache cache, int times, Action action)
    {
